...
set CLASSPATH=%APP_HOME%\lib\ktor-note-app-all.jar

@rem Execute ktor-note-app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_NOTE_APP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_NOTE_APP_EXIT_CONSOLE%" exit 1
exit /b 1
